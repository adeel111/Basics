...
public class SignupActivity extends AppCompatActivity {
    ...
    EditText edtTxtEamil,edtTxtPassword,edtTxtName,edtTxtPhone,edtTxtBusNo;
    String email,password,name,phone,busNo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                busNo= edtTxtBusNo.getText().toString().trim();


                if(Common.isConnectedtoInternet(SignupActivity.this)){
                    if(email.isEmpty() && password.isEmpty() && name.isEmpty() && phone.isEmpty() && busNo.isEmpty()){
    ...
    private void saveDataToDb() {
        DatabaseReference dbRef = FirebaseDatabase.getInstance().getReference("Drivers");
    ...
    private void initizalizations() {
        ...
        edtTxtBusNo=findViewById(R.id.edt_txt_bus_number);
